...
INPUT_VIDEO = "Animation vs. Geometry Dash - Alan Becker (360p, h264).mp4"
OUTPUT_FILE = "stickman.vs.geometry_dash.bin"
...
def main():
    ...
    target_fps = int(round(source_fps)) if (source_fps > 0 and source_fps <= 30) else 24
